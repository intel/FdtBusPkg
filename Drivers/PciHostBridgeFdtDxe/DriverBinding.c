  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((
      DEBUG_ERROR,
      "%a: InstallMultipleProtocolInterfaces(%p): %r\n",
      __func__,
      ControllerHandle,
      Status
      ));
  ...
  )
{
  ...
  RootBridge = PCI_ROOT_BRIDGE_FROM_THIS (RootBridgeIo);
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((
      DEBUG_ERROR,
      "%a: UninstallMultipleProtocolInterfaces(%p): %r\n",
      __func__,
      ControllerHandle,
      Status
      ));
